;(function (window) {
  ...
  let texts = ['男孩独自仰望', '星海闪烁', '仿佛在问', '为什么你一个人', '我在等一个人', '一个女孩', '这个女孩', '真没什么好的', '性格很倔强', '脾气又不好', '还很强势', '但男孩觉得', '这都是表面', '在他的眼中', '女孩任性起来', '耍起混来的时候', '真的很可爱', '可是', '就是这样的她', '也非常的脆弱', '也有', '伤心难过的时候', '而男孩', '看着她', '想要做一千件事', '让她开心起来', '因为男孩知道', '女孩心中有个人', '那是一座女孩', '筑起的城堡', '男孩走不近', '只能呆呆望着', '其实他也知道', '这样很傻', '但是放下', '却做不到', '在城堡外', '继续等待', '男孩再次抬头', '望向星空', '嘿', '女孩', '我能成为', '你的星星吗', '小小的星光', '不过分炙热', '不会灼伤你', '让你耍赖', '给你依赖', '给你幸福', '等待着你', 'Always','我的心中写的','都是你的名字','小小的心藏着一个大大的人','很深很仔细的藏着。','如果爱你是错的话','我不想对','如果对是等于没有你的话','我宁愿错一辈子','如果非要把着份爱加上一个期限','我希望是','一万年']
